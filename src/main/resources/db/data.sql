...
(created_at, updated_at, description, end_date, name, price, rating, running_time, session_date, session_time,
 start_date, venue_address, venue_name, user_id, genre_id)
VALUES
    (now(), now(), '최고의 감동을 선사하는 클래식 공연입니다.', '2025-08-31', '공연01', 120000, '전체연령가', 120, '2025-08-16', 19, '2025-08-01',
     '서울 강남구 테헤란로 123', '코엑스 오디토리움', 1, 1),
    (now(), now(), '잊지 못할 추억을 만드는 밴드 콘서트입니다.', '2025-08-31', '공연02', 90000, '15세 관람가', 90, '2025-08-17', 19, '2025-08-01',
     '서울 서초구 남부순환로 2406', '예술의전당 콘서트홀', 1, 2),
    (now(), now(), '국내 최정상 아이돌 그룹의 화려한 무대!', '2025-09-30', '공연03', 150000, '15세 관람가', 150, '2025-09-13', 19, '2025-09-01',
     '서울 송파구 올림픽로 424', '올림픽공원 체조경기장', 1, 2),
    (now(), now(), '웅장한 스케일의 오페라를 만나보세요.', '2025-09-30', '공연04', 100000, '12세 관람가', 100, '2025-09-27', 19, '2025-09-01',
     '서울 종로구 세종대로 175', '세종문화회관 대극장', 1, 1),
    (now(), now(), '인디 밴드의 뜨거운 에너지를 느낄 수 있는 소극장 공연입니다.', '2025-09-30', '공연05', 55000, '19세 이상 관람가', 60, '2025-09-28', 19, '2025-09-01',
     '서울 마포구 어울마당로 65', '홍대 상상마당 라이브홀', 1, 2),
    (now(), now(), '국내외 유명 뮤지컬 배우들이 총출동하는 특별 공연입니다.', '2025-09-30', '공연06', 110000, '12세 관람가', 110, '2025-09-28', 19, '2025-09-01',
     '서울 용산구 이태원로 294', '블루스퀘어 신한카드홀', 1, 1),
    (now(), now(), '현대 예술 작품을 감상할 수 있는 감각적인 전시회입니다.', '2025-10-31', '공연07', 20000, '전체연령가', 30, '2025-10-04', 18, '2025-10-01',
     '서울 성동구 왕십리로 83-21', '디뮤지엄', 1, 3),
    (now(), now(), '새로운 시각으로 세상을 바라보는 특별 전시입니다.', '2025-10-31', '공연08', 15000, '전체연령가', 30, '2025-10-04', 18, '2025-10-01',
     '서울 종로구 삼청로 30', '국립현대미술관 서울관', 1, 3),
    (now(), now(), '세계적인 피아니스트의 리사이틀을 즐겨보세요.', '2025-11-30', '공연09', 70000, '전체연령가', 30, '2025-11-09', 19, '2025-11-01',
     '서울 송파구 올림픽로 300', '롯데콘서트홀', 1, 2),
    (now(), now(), '유명 아티스트들의 합동 무대가 펼쳐집니다.', '2025-11-30', '공연10', 130000, '전체연령가', 120, '2025-11-22', 20, '2025-11-01',
     '서울 송파구 올림픽로 25', '잠실 실내체육관', 1, 2);
